...
const Navbar=()=>{
    ...
    <nav className='bg-gradient-to-r from-slate-500 to-slate-800'>
      <ul className="flex row  justify-between p-6 w-[30px]">
        ...
        <form onSubmit={""} className=' position-relative left-[20px]'>
        ...
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor" className="h-8 w-16 px-3.5 pt-3 border-r border-transparent peer-focus:border-white-300 stroke-gray-500 peer-focus:stroke-white-200 transition-all duration-300 focus:w-[200px]">
